...
(function() {
    ...
    $.fn.setPenStrokeWidth = function(strokeWidth){
        LC.penStrokeWidth = strokeWidth;
    };
    $.fn.setEraserStrokeWidth = function(strokeWidth){
        LC.eraserStrokeWidth = strokeWidth;
    };
            ...
            <div class="toolbar-row-right">\
                ...
                <div class="flyout-wrap">\
                  ...
                  <ul class="flyout flyout-init">\
                    ...
                    <li><a href="#" class="button btn-warning undo-button" style="background: url(/img/senceui/draw/drawSG_ui-11.png) no-repeat center center;background-size: 32px 32px;"><span></span></a></li>\
                    <li><a href="#" class="button btn-warning redo-button" style="background: url(/img/senceui/draw/drawSG_ui-10.png) no-repeat center center;background-size: 32px 32px;"><span></span></a></li>\
                    <li><a href="#" class="button btn-inverse zoom-out-button" style="background: url(/img/senceui/draw/button-05.png) no-repeat center center;background-size: 32px 32px;"><span></span></a></li>\
                    <li><a href="#" class="button btn-inverse zoom-in-button" style="background: url(/img/senceui/draw/button-04.png) no-repeat center center;background-size: 32px 32px;"><span></span></a></li>\
                  </ul>\
                </div>\
                </div>\
            </div>\
...
(function() {
    ...
    LC.RectangleTool = function(_super) {
        ...
        RectangleTool.prototype.begin = function(x, y, lc) {
            return this.currentShape = new LC.Rectangle(x, y, LC.penStrokeWidth/*this.strokeWidth*/, lc.primaryColor);
        };
    ...
    LC.LineTool = function(_super) {
        ...
        LineTool.prototype.begin = function(x, y, lc) {
            return this.currentShape = new LC.Line(x, y, LC.penStrokeWidth/*this.strokeWidth*/, lc.primaryColor);
        };
    ...
    LC.Pencil = function(_super) {
        ...
        Pencil.prototype.makePoint = function(x, y, lc) {
            return new LC.Point(x, y, LC.penStrokeWidth/*this.strokeWidth*/, this.color);
        };
    ...
    //        this.strokeWidth = 10;
        ...
        Eraser.prototype.makePoint = function(x, y, lc) {
            return new LC.Point(x, y, LC.eraserStrokeWidth/*this.strokeWidth*/, "#000");
        };
